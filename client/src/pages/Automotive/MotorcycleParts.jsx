// src/pages/Automotive/MotorcycleParts.jsx
import React, { useEffect, useState } from "react";
import { Link } from "react-router-dom";
import "../../styles/Cameras.css";

export default function MotorcycleParts() {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch(
          "http://localhost:5000/api/products?category=automotive&sub_category=Motorcycle Parts"
        );
  ...
  return (
    <div className="page-container">
      ...
      <main className="main-content">
        <h2>Bullet Motorcycle Parts</h2>
        <p className="section-subtitle">Best Seller</p>

        {products.length === 0 ? (
          <p>No Motorcycle Parts found.</p>
        ) : (
